...
raw_password = "TravelStay123!"
safe_password = urllib.parse.quote_plus(raw_password)
SQLALCHEMY_DATABASE_URL = f"mysql+pymysql://admin:{safe_password}@travelstay-db.couwaczgmvhi.us-east-1.rds.amazonaws.com:3306/travelstay" # 数据会存放在当前目录的这个文件里
